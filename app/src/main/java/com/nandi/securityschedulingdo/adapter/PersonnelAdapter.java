...
import com.nandi.securityschedulingdo.bean.PersonnelInfo;
...
public class PersonnelAdapter extends RecyclerView.Adapter<PersonnelAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            picture = itemView.findViewById(R.id.iv_rc_person_2);
            title = itemView.findViewById(R.id.tv_rc_person_1);
            name = itemView.findViewById(R.id.tv_rc_person_3);
            phone = itemView.findViewById(R.id.tv_rc_person_4);
        }
    }
}
